...
r={enumerable:r.enumerable,writable:r.writable,configurable:r.configurable,value:void 0===i?void 0:i.call(e)}}Object.defineProperty(e,t.key,r)}function u(e,t,r){var i=t[e.placement]
if(!r&&-1!==i.indexOf(e.key))throw new TypeError("Duplicated element ("+e.key+")")
i.push(e.key)}function d(e){var t={kind:e.kind,key:e.key,placement:e.placement,descriptor:e.descriptor}
...
for(var w=[],x=[],_=[],E=0;E<254;E++){if(E<127.5)w.push(2*E),x.push(0)
else{var P=E-102
w.push(255),x.push(1.7*P)}_.push(0)}w.push(255),x.push(255),_.push(255)
...
setTimeout(function(){e._renderFire()},1)}},{kind:"method",key:"_renderFire",value:function(){this._growFire(),this._drawFire(),this._loop()}},{kind:"method",key:"_growFire",value:function(){for(var e=0;e<this.canvas.height;e++)for(var t=0;t<this.canvas.width;t++)0!==this.pixels[e][t]&&this._growPixel(e,t)}},{kind:"method",key:"_growPixel",value:function(e,t){var r=this.pixels[e][t],i=10*Math.random(),n=i-5-1,o=Math.round(t+.7*n),a=Math.round(e-1.6*i),s=2-r/255,l=Math.round(s*i*1.2)
a<0&&(a=0),a>=this.canvas.height&&(a=this.canvas.height-1),o<0&&(o=0),o>=this.canvas.width&&(o=this.canvas.width-1)
var c=this.pixels[e][t]-Math.round(.92*l)
if(this.pixels[a][o]=c>0?c:0,!this.eternalFlame||this.eternalFlame&&e!==this.canvas.height-1){var f=r-l
this.pixels[e][t]=f>0?f:0}}},{kind:"method",key:"_drawFire",value:function(){for(var e=0;e<this.canvas.height;e++)for(var t=0;t<this.canvas.width;t++)this._setImagePixel(e,t,this.pixels[e][t])
...
var s=d(e),l=m((0,n[o])(s)||s)
u(e=l.element,t),l.finisher&&i.push(l.finisher)
var c=l.extras
if(c){for(var f=0;f<c.length;f++)u(c[f],t)
