...
setTimeout(function(){e._renderFire()},1)}},{kind:"method",key:"_renderFire",value:function(){this._growFire(),this._drawFire(),this._loop()}},{kind:"method",key:"_growFire",value:function(){for(var e=0;e<this.canvas.height;e++)for(var t=0;t<this.canvas.width;t++)0!==this.pixels[e][t]&&this._growPixel(e,t)}},{kind:"method",key:"_growPixel",value:function(e,t){var r=this.pixels[e][t],i=Math.round(5*Math.random()),n=t+Math.round(i-2.6),o=e-(i+1),a=8-r/51
o<0&&(o=0),n<0&&(n=0),n>this.canvas.width&&(n=this.canvas.width-1)
var s=this.pixels[e][t]-a/4
if(this.pixels[o][n]=s>0?s:0,!this.eternalFlame||this.eternalFlame&&e!==this.canvas.height-1){var l=r-a
this.pixels[e][t]=l>0?l:0}}},{kind:"method",key:"_drawFire",value:function(){for(var e=0;e<this.canvas.height;e++)for(var t=0;t<this.canvas.width;t++)this._setImagePixel(e,t,this.pixels[e][t])
...
if(r<127.5)this.image.data[i]=r,this.image.data[i+1]=0,this.image.data[i+2]=0
else if(r<255){var n=r-102
this.image.data[i]=255,this.image.data[i+1]=1.7*n,this.image.data[i+2]=0}else 255===r&&(this.image.data[i]=255,this.image.data[i+1]=255,this.image.data[i+2]=255)
this.image.data[i+3]=255}},{kind:"get",key:"canvas",value:function(){return this._canvas||(this._canvas=this.element.querySelector("canvas")),this._canvas}},{kind:"get",key:"context",value:function(){return this._context||(this._context=this.canvas.getContext("2d")),this.canvas.getContext("2d")}}]}},_=Ember.Component,O=x(function(e){(function(e,t){["method","field"].forEach(function(r){t.forEach(function(t){t.kind===r&&"own"===t.placement&&f(e,t)})})})(e,F.elements)},_),F=function(e,t){var r=[],i=[],n={static:[],prototype:[],own:[]}
